  ...
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="操作"  width="" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <!-- <el-button type="success" size="mini" @click="handleEditAppShareInfo(scope.row)">编辑</el-button> -->
          <el-button type="danger" size="mini" @click="handleDeleteAppShareInfo(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import { pageListAppShareInfo, listAppShareInfo, detailAppShareInfo, saveAppShareInfo, updateAppShareInfo, delAppShareInfo } from '@/api/AppShareInfo.js'
  ...
  export default {
    ...
    methods: {
      ...
      // 加载数据
      pageListAppShareInfo() {
        this.listLoading = true
        pageListAppShareInfo(this.listQuery).then(response => {
